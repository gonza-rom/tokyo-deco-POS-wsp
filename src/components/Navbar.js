        ...
        >
          ...
          >
            {links.map((l) => (
              <Link
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = '#c24b2e'
                  e.currentTarget.style.borderBottomColor = '#c24b2e'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = 'rgba(18,14,10,0.55)'
          ...
          >
            ...
            <a
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = 'rgba(18,14,10,0.45)'
              }}
            >
              <Instagram size={18} />
            </a>
            ...
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = 'rgba(18,14,10,0.6)'
              }}
            >
              <ShoppingBag size={20} />
